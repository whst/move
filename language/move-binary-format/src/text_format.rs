...
use crate::{file_format::Bytecode, file_format_common::Opcodes};
...
#[cfg(test)]
mod tests {
    use crate::{file_format::basic_test_module, CompiledModule};
    ...
    fn test_json_format() {
        ...
        println!("{}", json);
        let deserialized_module = serde_json::from_str(&json).unwrap();
